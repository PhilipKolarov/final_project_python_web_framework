...
from music_services.web.views import index, service_create, service_edit, service_delete, review_create, review_edit, \
    ReviewDeleteView, recommendation_create, about, service_details, catalogue, review_create_success, \
...
urlpatterns = [
    ...
    path('review/', include([
        ...
        path('create_success/', review_create_success, name='review create success'),
        path('delete_success/', review_delete_success, name='review delete success'),
